<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stud_num = filter_input(INPUT_POST, "student_number", FILTER_SANITIZE_SPECIAL_CHARS);
        ...
        if($is_password){
            header("Location: student_email_verification.php");
            die();
        }else{
            echo "Error";
        }
